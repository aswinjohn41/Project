...
$data=mysqli_query($conn,"SELECT * FROM bus_tb ");
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  while($row = mysqli_fetch_assoc($data)) { $count++; ?>
                    <tr>
                      ...
                      <td><a href="dlt_buses.php?b_id=<?php echo $row['id'] ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a></td>
                    </tr>
                    <?php  } ?>
                  </tbody>
                </table>
