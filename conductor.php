...
$data=mysqli_query($conn,"SELECT * FROM conductor_tb JOIN login_tb ON conductor_tb.login_id=login_tb.login_id JOIN bus_tb ON bus_tb.id=conductor_tb.bus_id ORDER BY conductor_name");
  ...
  <body class="app sidebar-mini">
   ...
   <?php include 'header.php'; ?>
    ...
    <main class="app-content">
      <div class="app-title">
        <div>
          <h1><i class="fa fa-dashboard"></i> Conductor Details</h1>
          <p></p>
        </div>
...
<div class="row">
        <div class="col-md-12">
          <div class="tile">
            <div class="row">
              <div class="col-lg-6">
           <a href="add_conductor.php"><button class="btn btn-primary"  type="submit">ADD CONDUCTOR</button></a>
            </div></div> </div></div></div>
